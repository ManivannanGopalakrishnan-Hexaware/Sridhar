...
namespace Blob_CRUD.Models
{
    public class BlobManager
    {
        ...
        public BlobManager()
        {
            try
            {
                string connectionString = "DefaultEndpointsProtocol=https;AccountName=sridharblob;AccountKey=62pKtu+2693kxaX1uLoCuqF5GKGrmITJVPPlFMLnsH1bFmk5EYCQgrSTjn9FkNyMfmMABwB7OC1ZeSrzoKfJ1A==;EndpointSuffix=core.windows.net";
